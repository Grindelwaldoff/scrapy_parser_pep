...
FEEDS = {
    f'{RESULT_DIRNAME}/pep_%(time)s.csv': {
        'format': 'csv',
...
SUMMARY_FIELD_NAMES = ('Status', 'Amount')
ITEM_PIPELINES = {
...
# lication/xhtml+xml,application/xml;q=0.9,*/*;q=0.8',
#   'Accept-Language': 'en',
# }
...
# See https://docs.scrapy.org/en/lat
# est/topics/downloader-middleware.html#httpcache-middleware-settings
